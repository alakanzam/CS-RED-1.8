...
public plugin_init() 
{
	...
	register_concmd("RDR_HUD/CharacterIcon", "clcmd_RedrawHud")
...
stock Draw_CharacterIcon(id)
{
	...
	if (!is_user_zombie(id))
	{
		...
		if (iCharacterId > -1)
		{
			...
			get_character_hud(iCharacterId, iTeam, szSPR, sizeof szSPR - 1, iInternalModel)
		}
		else
		{
			new CsTeams:iTeam = cs_get_user_team(id)	
